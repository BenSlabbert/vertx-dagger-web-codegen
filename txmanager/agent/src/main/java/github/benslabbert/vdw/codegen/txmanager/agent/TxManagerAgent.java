...
import static github.benslabbert.vdw.codegen.annotation.transaction.AlreadyTransformed.Transformer.AGENT;

import github.benslabbert.vdw.codegen.annotation.transaction.AfterCommit;
import github.benslabbert.vdw.codegen.annotation.transaction.AlreadyTransformed;
...
import github.benslabbert.vdw.codegen.txmanager.agent.delegate.AfterCommitDelegator;
import github.benslabbert.vdw.codegen.txmanager.agent.delegate.BeforeCommitDelegator;
...
public final class TxManagerAgent {
  ...
  private static AnnotationDescription alreadyTransformed(
      AlreadyTransformed.Transformer transformer) {
