...
package github.benslabbert.vdw.codegen.txmanager.agent.delegate;
...
public final class BeforeCommitDelegator {

  private BeforeCommitDelegator() {}

  //    @BeforeCommit
  //    public void beforeCommitVoid() {
  //        BeforeCommitDelegator.wrap(new auxiliary.v1Kp9I6P(this));
  //    }
